...
regions = {
    ...
    # Aggiungere un taglio loose bjet>0 in AllSrs mentre in ZJets richiedi 0 loos bjet 
    # per ortogonalizzare le due regione
    # Aggiungere SR con 0frwrd jet e almeno 1 forward
