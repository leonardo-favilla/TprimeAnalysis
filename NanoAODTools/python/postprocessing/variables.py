...
vars.append(variable(name = "FatJet_particleNetWithMass_TvsQCD",    title= "Top Merged Score",              nbins = 40, xmin = 0, xmax=1, noUnOvFlowbin = True))
...
regions = {
    ...
    ################### May2024
    "presel"                        : "",
    "topResolved_topmatched"        : topResolved_topmatched,
    "topResolved_nonmatched"        : topResolved_nonmatched,
    "topResolved_other"             : topResolved_other,
    "topMixed_topmatched"           : topMixed_topmatched,
    "topMixed_nonmatched"           : topMixed_nonmatched,
    "topMixed_other"                : topMixed_other,
    "topMerged_topmatched"          : topMerged_topmatched,
    "topMerged_nonmatched"          : topMerged_nonmatched,
    "topMerged_other"               : topMerged_other,
