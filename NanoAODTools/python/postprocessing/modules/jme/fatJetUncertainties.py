...
class fatJetUncertaintiesProducer(Module):
    def __init__(
        ...
        self.jesArchive = tarfile.open(
            ...
            ".tar.gz", "r:gz") if not archive else tarfile.open(
        ...
        for jet in jets:
            ...
            if self.doGroomed:
                ...
                if not self.isData:
                    ...
                    elif self.era in ["2022"]:
                        jmstau21DDTNomVal = 1.000   # placeholder# tau21DDT < 0.43 WP
                        jmstau21DDTDownVal = 1.000  # placeholder
                        jmstau21DDTUpVal = 1.000    # placeholder
                        self.jetSmearer.jmr_vals = [1.000, 1.000, 1.000] # placeholder
