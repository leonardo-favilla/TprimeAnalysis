...
p=PostProcessor('.', ['root://cms-xrd-global.cern.ch//store/mc/Run3Summer22NanoAODv12/TprimeBtoTZ_M-1300_LH_TuneCP5_13p6TeV_madgraph-pythia8/NANOAODSIM/130X_mcRun3_2022_realistic_v5-v4/120000/50a168fa-b51e-4436-b174-19f7951be88c.root'], '', modules=[MCweight_writer(),MET_Filter(year = 2022),JetVetoMaps_run3(year=2022,EE=0),preselection(),PUreweight(year=2022,EE=0),BTagSF(year=2022,EE=0),GenPart_MomFirstCp(flavour='-5,-4,-3,-2,-1,1,2,3,4,5,6,-6,24,-24'),nanoprepro(),nanoTopcand(isMC=True),globalvar(), nanoTopevaluate_MultiScore(year = 2022, modelMix_path='/afs/cern.ch/user/l/lfavilla/TprimeAnalysis/NanoAODTools/python/postprocessing/data/dict_tresholds/model_TopMixed_2022_p2.h5', modelRes_path='/afs/cern.ch/user/l/lfavilla/TprimeAnalysis/NanoAODTools/python/postprocessing/data/dict_tresholds/model_TopResolved_2022.h5')], provenance=True, haddFileName='tree.root', fwkJobReport=False, histFileName='hist.root', histDirName='plots', outputbranchsel='/afs/cern.ch/user/l/lfavilla/TprimeAnalysis/NanoAODTools/scripts/keep_and_drop.txt', maxEntries=100)
p.run()
print('DONE')
