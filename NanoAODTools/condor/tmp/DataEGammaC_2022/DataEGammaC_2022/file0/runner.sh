...
pwd
davix-put tree_hadd_0.root davs://stwebdav.pi.infn.it:8443/cms/store/user/acagnott/Run3Analysis_Tprime/DataEGammaC_2022/20240702_113059/tree_hadd_0.root -E $1 --capath /cvmfs/cms.cern.ch/grid/etc/grid-security/certificates/
